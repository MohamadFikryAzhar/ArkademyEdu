                    ...
                    <div className="news-card r-10px sm:mt-3 mr-1">
                        ...
                        <div className="news-image-container mt-3">
                            ...
                            <div className="flex items-center justify-center py-3 text-style">
                                <Link href="./dashboard" className="cursor-pointer text-color text-link text-blue-400">All schedule&nbsp;</Link>
                                <Link href="./foryou" className="cursor-pointer text-color-2 text-link text-gray-600">For You</Link>
                            </div>
                            ...
                            <div className="show">
                                ...
                                <div className="date-detail flex-row gap-5 overflow-x-scroll w-full justify-between pb-10">
                                    <div className="date-time min-w-[200px]">
                                        <span className="text-span">Fundamental<Image align="right"
                                    ...
                                    <div className="date-time min-w-[200px]">
                                        <span className="text-span">JavaScript<Image align="right"
                                            className="dots-top pt-5 pl-5" src={dots} alt="" /></span>
                                        <span className="text-span-1">30 Minutes <Image align="right" className="money-top h-20 w-20"
                                            src={history} alt="" /></span>
                                    </div>
                            ...
                            <div className="show">
                                ...
                                <div className="date-detail flex-row gap-5 overflow-x-scroll w-full justify-between pb-10">
                                    <div className="date-time min-w-[200px]">
                                        <span className="text-span">FrontEnd Fundamental<Image align="right"
                                            className="dots-top pt-5 pl-5" src={dots} alt="" /></span>
                                        <span className="text-span-1">60 Minutes <Image align="right" className="money-top w-1/2 h-1/2"
